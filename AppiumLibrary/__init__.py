...
class AppiumLibrary(
    ...
    def __init__(self, timeout=5, run_on_failure='Capture Page Screenshot', sleep_between_wait_loop=0.2,
                 self_healing=False, update_healed_locator=False, update_file_extensions=None, similarity_percentage=0.93,
                 healing_strategy='xpath', heal_with_llm=False, OpenAI_key=None, llm_model="gpt-4o-mini"):
        ...
        self.set_appium_self_healing(self_healing, update_healed_locator, update_file_extensions, similarity_percentage,
